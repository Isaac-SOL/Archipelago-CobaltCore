...
item_table: Dict[str, ItemData] = {
    ...
    "Block Shot":       ItemData(card_off + dizzy_off + C + 1, "Card", True, character="Dizzy", rarity="Common", starter=True, offensive=True),
    ...
    "Deflection":       ItemData(card_off + dizzy_off + C + 4, "Card", True, character="Dizzy", rarity="Common", offensive=True),
    ...
    "Acid Cannon":      ItemData(card_off + dizzy_off + UC,     "Card", True, character="Dizzy", rarity="Uncommon", offensive=True),
    ...
    "Corrosion Beam": ItemData(card_off + dizzy_off + R,     "Card", True, character="Dizzy", rarity="Rare", offensive=True),
    ...
    "Draw Shot":      ItemData(card_off + riggs_off + C + 1, "Card", True, character="Riggs", rarity="Common", starter=True, offensive=True),
    "Evasive Shot":   ItemData(card_off + riggs_off + C + 2, "Card", True, character="Riggs", rarity="Common", offensive=True),
    ...
    "Whiplash":       ItemData(card_off + riggs_off + C + 8, "Card", True, character="Riggs", rarity="Common", offensive=True),

    "Charge Beam":      ItemData(card_off + riggs_off + UC,     "Card", True, character="Riggs", rarity="Uncommon", offensive=True),
    ...
    "Hand Cannon":     ItemData(card_off + riggs_off + R + 1, "Card", True, character="Riggs", rarity="Rare", offensive=True),
    ...
    "Lunge":         ItemData(card_off + peri_off + C + 3, "Card", True, character="Peri", rarity="Common", starter=True, offensive=True),
    "Multi Blast":   ItemData(card_off + peri_off + C + 4, "Card", True, character="Peri", rarity="Common", offensive=True),
    "Multi Shot":    ItemData(card_off + peri_off + C + 5, "Card", True, character="Peri", rarity="Common", starter=True, offensive=True),
    ...
    "Wave Charge":   ItemData(card_off + peri_off + C + 8, "Card", True, character="Peri", rarity="Common", offensive=True),

    "Barrage":           ItemData(card_off + peri_off + UC,     "Card", True, character="Peri", rarity="Uncommon", offensive=True),
    ...
    "Frontloaded Blast": ItemData(card_off + peri_off + UC + 3, "Card", True, character="Peri", rarity="Uncommon", offensive=True),
    ...
    "Endless Magazine": ItemData(card_off + peri_off + R,     "Card", True, character="Peri", rarity="Rare", offensive=True),
    ...
    # Isaac
    "Attack Drone":   ItemData(card_off + isaac_off + C,     "Card", True, character="Isaac", rarity="Common", starter=True, offensive=True),
    "Flex Move":      ItemData(card_off + isaac_off + C + 1, "Card", True, character="Isaac", rarity="Common"),
    "Missile Shot":   ItemData(card_off + isaac_off + C + 2, "Card", True, character="Isaac", rarity="Common", offensive=True),
    ...
    "Shift Shot":     ItemData(card_off + isaac_off + C + 5, "Card", True, character="Isaac", rarity="Common", offensive=True),
    ...
    "Space Mine":     ItemData(card_off + isaac_off + C + 8, "Card", True, character="Isaac", rarity="Common", offensive=True),
    ...
    "EMP Slug":           ItemData(card_off + drake_off + C + 2, "Card", True, character="Drake", rarity="Common", starter=True, offensive=True, generator=True),
    "Exothermic Release": ItemData(card_off + drake_off + C + 3, "Card", True, character="Drake", rarity="Common"),
    "Explosive Slug":     ItemData(card_off + drake_off + C + 4, "Card", True, character="Drake", rarity="Common", offensive=True, generator=True),
    "Firewall":           ItemData(card_off + drake_off + C + 5, "Card", True, character="Drake", rarity="Common", generator=True),
    ...
    "Aggressive Armoring": ItemData(card_off + drake_off + UC,     "Card", True, character="Drake", rarity="Uncommon", offensive=True),
    "Flash Point":         ItemData(card_off + drake_off + UC + 1, "Card", True, character="Drake", rarity="Uncommon", offensive=True),
    "Heatwave":            ItemData(card_off + drake_off + UC + 2, "Card", True, character="Drake", rarity="Uncommon", generator=True),
    "Sear":                ItemData(card_off + drake_off + UC + 3, "Card", True, character="Drake", rarity="Uncommon", offensive=True, generator=True),
    ...
    "Volatile Vapor":      ItemData(card_off + drake_off + UC + 6, "Card", True, character="Drake", rarity="Uncommon", offensive=True),

    "Freeze Dry":          ItemData(card_off + drake_off + R,     "Card", True, character="Drake", rarity="Rare", offensive=True),
    ...
    "Thermal Battery":     ItemData(card_off + drake_off + R + 4, "Card", True, character="Drake", rarity="Rare", generator=True),
    ...
    "Dice Roll":       ItemData(card_off + max_off + C + 2, "Card", True, character="Max", rarity="Common", offensive=True),
    ...
    "Reroute":         ItemData(card_off + max_off + C + 5, "Card", True, character="Max", rarity="Common", offensive=True),
    "Shuffle Shot":    ItemData(card_off + max_off + C + 6, "Card", True, character="Max", rarity="Common", offensive=True),
    ...
    "Lazy Barrage":      ItemData(card_off + max_off + UC + 3, "Card", True, character="Max", rarity="Uncommon", offensive=True),
    "Memory Leak":       ItemData(card_off + max_off + UC + 4, "Card", True, character="Max", rarity="Uncommon", offensive=True),
    ...
    # Books
    "Glimmer Shot":       ItemData(card_off + books_off + C,     "Card", True, character="Books", rarity="Common", offensive=True),
    "Mage Hand":          ItemData(card_off + books_off + C + 1, "Card", True, character="Books", rarity="Common", starter=True, offensive=True),
    ...
    "Mining Drill":       ItemData(card_off + books_off + C + 4, "Card", True, character="Books", rarity="Common", offensive=True, generator=True),
    "Sapphire Shield":    ItemData(card_off + books_off + C + 5, "Card", True, character="Books", rarity="Common", generator=True),
    "Swizzle Shift":      ItemData(card_off + books_off + C + 6, "Card", True, character="Books", rarity="Common"),
    "Unpolished Crystal": ItemData(card_off + books_off + C + 7, "Card", True, character="Books", rarity="Common", starter=True, generator=True),
    ...
    "Bloodstone Bolt": ItemData(card_off + books_off + UC + 2, "Card", True, character="Books", rarity="Uncommon", offensive=True),
    "Catch":           ItemData(card_off + books_off + UC + 3, "Card", True, character="Books", rarity="Uncommon"),
    "Mineral Deposit": ItemData(card_off + books_off + UC + 4, "Card", True, character="Books", rarity="Uncommon", generator=True),
    "Ol' Reliable":    ItemData(card_off + books_off + UC + 5, "Card", True, character="Books", rarity="Uncommon"),
    "Shardpack":       ItemData(card_off + books_off + UC + 6, "Card", True, character="Books", rarity="Uncommon", generator=True),

    "Medusa Field":      ItemData(card_off + books_off + R,     "Card", True, character="Books", rarity="Rare", generator=True),
    "Overflowing Power": ItemData(card_off + books_off + R + 1, "Card", True, character="Books", rarity="Rare"),
    "Perfect Specimen":  ItemData(card_off + books_off + R + 2, "Card", True, character="Books", rarity="Rare", generator=True),
    "Quantum Quarry":    ItemData(card_off + books_off + R + 3, "Card", True, character="Books", rarity="Rare", generator=True),
    ...
    "Scaffold Trap": ItemData(filler_off + 5, "Trap",   False)
}
